...
pimcore.plugin.objectmerger.panel = Class.create({
    ...
    initialize: function (sourceObjectReceiver, sourceParam, targetObjectReceiver, targetParam) {
        /*
        this.id = oid1 + "_" + oid2;
        this.oid1 = oid1;
        this.oid2 = oid2;
...
*/
        ...
        this.oid1 = sourceParam;
        this.oid2 = targetParam;
        this.id = this.oid1 + "_" + this.oid2;



        this.sourceObjectReceiver = sourceObjectReceiver;
    ...
    save: function () {
        ...
        Ext.Ajax.request({
            ...
            params: {
                //id: this.oid2,
                targetObjectReceiver: this.targetObjectReceiver,
...
//                forceLayout: true,
        ...
        Ext.Ajax.request({
            ...
            method: "post",
            params: {
                sourceObjectReceiver: this.sourceObjectReceiver,
    ...
    updateTitle: function() {
        ...
        var titel1 = this.data.o1key ? this.data.o1key : "tmp-object";
        var titel2 = this.data.o2key ? this.data.o2key : "tmp-object";

        var title = t("plugin_objectmerger_diff") + " " + titel1 + "<>" + titel2;
        if (this.changeCount) {
            title = title + " *";
        }
